COMANDOS_SUP = {
    ...
    "CPE-BRANCH": [
        ...
        "show ip ospf database router",
        "show ip route ospf",
        "show ip cef 192.168.25.3",
        "show ip cef exact-route 172.16.10.2 192.168.25.3",
        "ping 192.168.25.3",
        "traceroute 192.168.25.3",
        "ping 172.16.10.5",
    ...
    "CPE-BRANCH2-BK": [
        ...
        "show ip nat statistics",
        "show ip interface brief",
        "show run interface Ethernet0/1.25",
        "ping 172.16.10.1",
        "traceroute 172.16.10.1",
    ],
