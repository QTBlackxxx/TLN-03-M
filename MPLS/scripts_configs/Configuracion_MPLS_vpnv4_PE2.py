...
import importlib
from configs import from_PE2_to_CPEs
from configs import SW_2
...
for router in routers:
    ...
    # Configuración de PE2 hacia CPE_2
    modulo = from_PE2_to_CPEs.config_vrf
    modulo_2 = from_PE2_to_CPEs.config_int_cpes
    modulo_3 = from_PE2_to_CPEs.config_routing
    #

    # Aplicamos configuraciones en PE2 hacia CPE_2
